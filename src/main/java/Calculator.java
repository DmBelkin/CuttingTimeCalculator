...
public class Calculator {
    ...
    private final double[][][] Vc_turning = new double[][][]{
            {{430, 0.5, 0.12}, {2000, 1, 0.2}, {150, 0.2, 0.1}, {250, 0.4, 0.2}, {400, 0.5, 0.2}, {120, 1, 0.05}, {2000, 1, 0.2}, {65, 1, 0.2}},
            {{395, 0.4, 0.2}, {2000, 2, 0.2}, {150, 0.2, 0.1}, {250, 0.4, 0.2}, {400, 0.5, 0.2}, {120, 1, 0.05}, {2000, 1, 0.2}, {65, 1, 0.2}},
            {{325, 3, 0.3}, {1900, 3, 0.35}, {150, 0.2, 0.1}, {180, 3, 0.3}, {300, 3, 0.3}, {120, 2, 0.2}, {1500, 3, 0.3}, {53, 2, 0.3}},
            {{290, 4, 0.4}, {1900, 4, 0.35}, {100, 0.2, 0.15}, {165, 4, 0.35}, {300, 3, 0.3}, {100, 2, 0.2}, {1500, 5, 0.5}, {53, 2, 0.3}},
            {{260, 5, 0.5}, {1300, 6, 0.6}, {100, 0.2, 0.15}, {135, 4, 0.5}, {270, 5, 0.5}, {100, 4, 0.25}, {1000, 5, 0.5}, {49, 4, 0.4}}
    };

    private final double[][][] Vc_threading = new double[][][]{
            {{115, 0.5, 0.12}, {1000, 1, 0.2}, {50, 0.2, 0.1}, {120, 0.4, 0.2}, {90, 0.5, 0.2}, {120, 1, 0.05}, {2000, 1, 0.2}, {100, 1, 0.2}},
            {{115, 0.4, 0.2}, {1000, 2, 0.2}, {50, 0.2, 0.1}, {120, 0.4, 0.2}, {90, 0.5, 0.2}, {120, 1, 0.05}, {2000, 1, 0.2}, {100, 1, 0.2}},
            {{90, 3, 0.3}, {1000, 3, 0.35}, {40, 0.2, 0.1}, {80, 3, 0.3}, {90, 3, 0.3}, {120, 2, 0.2}, {1500, 3, 0.3}, {100, 2, 0.3}},
            {{90, 4, 0.4}, {1000, 4, 0.35}, {40, 0.2, 0.15}, {80, 3, 0.35}, {90, 3, 0.3}, {100, 2, 0.2}, {1500, 5, 0.5}, {100, 2, 0.3}},
            {{70, 5, 0.5}, {1000, 6, 0.6}, {30, 0.2, 0.15}, {50, 5, 0.5}, {90, 5, 0.5}, {100, 4, 0.25}, {1000, 5, 0.5}, {100, 4, 0.4}}
    };
    ...
    private final double[][][] Vc_end_milling = new double[][][]{
            ...
            {{250, 0.2, 2}, {590, 0.3, 3}, {10, 0.1, 1}, {190, 0.2, 1.5}, {300, 0.2, 2}, {120, 2, 0.2}, {1500, 3, 0.3}, {95, 0.2, 1}},
            {{250, 0.2, 3}, {590, 0.3, 4}, {10, 0.1, 1}, {190, 0.2, 2}, {300, 0.2, 3}, {100, 2, 0.2}, {1500, 5, 0.5}, {95, 0.2, 1}},
            {{200, 0.3, 3}, {590, 0.3, 5}, {10, 0.1, 2}, {155, 0.3, 2.5}, {300, 0.2, 4}, {100, 4, 0.25}, {1000, 5, 0.5}, {95, 0.2, 2}}
    };
    ...
    public double computeTurning(Data data) {
        ...
        if (data.getToolType().equals("Turning out") || data.getToolType().equals("Boring")) {
            ...
            double Vcs = Vc_turning[3][column][0];
            result += calculateTime(data.getDepth(), Vc_turning[2][column][2],
            ...
            if (data.getQualitat() <= 8) {
                result += calculateTime(data.getLength(), grooveFactor(Vc_turning[0][column][2]),
                        spinCount(Vc4, data.getDiameter())) + Tpz;
            }
    ...
    public double computeMilling(Data data) {
        ...
        double oneRowV = (data.getMillDiameter() / 4) * Vc_end_milling[4][column][2] * data.getDepth();
        ...
        double oneRowV1 = (data.getMillDiameter() / 6) * Vc_end_milling[2][column][2] * data.getDepth();
        ...
        double oneRowV2 = (data.getMillDiameter() / 8) * Vc_end_milling[1][column][2] * data.getDepth();
